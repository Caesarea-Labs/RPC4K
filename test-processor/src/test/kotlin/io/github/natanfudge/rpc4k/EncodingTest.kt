...
import io.github.natanfudge.rpc4k.impl.encodeAndJoin
...
//    @Test
//    fun `A string is encoded and decoded propertly`() {
//        val array = """
//            class io.github.natanfudge.rpc4k.EncodingTest {
//    @Test
//    fun `A string is encoded and decoded propertly`() {
//        val array = ""${'"'}
//
...
//
//    @Test
//    fun `An explicit ByteArray is encoded and decoded properly`() {
//        val array2 = byteArrayOf(0x00, 0x01, 0x00, 0x03, 0x01, 0x04, 0x00)
//        val encoded2 = array2.encodeToSplitable()
//        val decoded2 = encoded2.decodeSplitable()
//    }
//}
//        """.toByteArray()
...
//    }
    ...
    fun `Empty List is combined and split properly`() {
        assertByteArrayListEquals(listOf<ByteArray>(), listOf<ByteArray>().encodeAndJoin().splitJoinedAndDecode())
    }
