...
// ) {
//     if (!(serializer instanceof SealedClassSerializer)) return;
...
//     if (kind instanceof SerialKind.ENUM) throw new Error("Enums cannot be serialized polymorphically with 'type' parameter. You can use 'JsonBuilder.useArrayPolymorphism' instead");
//     if (kind instanceof PrimitiveKind) throw new Error("Primitives cannot be serialized polymorphically with 'type' parameter. You can use 'JsonBuilder.useArrayPolymorphism' instead");
//     if (kind instanceof PolymorphicKind) throw new Error("Actual serializer for polymorphic cannot be polymorphic itself");
// }
//
...
// }
//
// function classDiscriminator(descriptor: SerialDescriptor, json: Json): string {
